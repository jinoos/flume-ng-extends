...
public class WasLogCplanetModule implements Configurable, DirectoryTailParserModulable
{
    private static final Logger logger                = LoggerFactory.getLogger(WasLogCplanetModule.class);
    ...
    public void parse(String line, FileSet fileSet)
    {
        ...
        if(match.find())
        {
            fileSet.setHeader("log_file", fileSet.getFileObject().getName().getPath());
    ...
    public void configure(Context context)
    {
        ...
        instanceName = context.getString(CONFIG_INSTANCE_NAME, DEFAULT_INSTANCE_NAME);
    }
}
